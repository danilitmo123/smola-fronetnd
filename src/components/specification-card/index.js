            ...
            <div
                ...
                <div className="specification-card-info">
                    <div className="specification-card-store">
                        <div className="about-store on-store">Собранных на
                            складе: <span>{currentCardData ? currentCardData.amount : null}</span> шт
                        </div>
                        <div className="about-store on-collected">Можно собрать из имеющихся
                            ресурсов: <span>{currentCardData ? currentCardData.available_to_assemble : null}</span> шт
                        </div>
                        ...
                        <div className="about-store">
                            ...
                            <div className={'about-store'}>
                                <button className={'calculate-btn'} onClick={() => setActiveModal(true)}>Собрать
                                </button>
                            </div>
                        </div>
                    </div>
